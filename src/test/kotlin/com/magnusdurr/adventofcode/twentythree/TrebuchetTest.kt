...
class TrebuchetTest {
    ...
    @Test
    fun `verify calibration value extraction`() {
        val trebuchet = Trebuchet()

        assertThat(trebuchet.numberFromLine("1abc2")).isEqualTo(12)
        assertThat(trebuchet.numberFromLine("pqr3stu8vwx")).isEqualTo(38)
        assertThat(trebuchet.numberFromLine("a1b2c3d4e5f")).isEqualTo(15)
        assertThat(trebuchet.numberFromLine("treb7uchet")).isEqualTo(77)
    }
    ...
    @Test
    fun `make sure addition works`() {
        Trebuchet().calibrationValueSum(listOf("1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet")).also {
            assertThat(it).isEqualTo(142)
        }
    }
